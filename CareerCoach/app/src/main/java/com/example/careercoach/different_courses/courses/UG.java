...
import com.example.careercoach.databinding.FragmentPGBinding;
import com.example.careercoach.databinding.FragmentUGBinding;
 ...
 * Use the {@link UG#newInstance} factory method to
 * create an instance of this fragment.
 */
public class UG extends Fragment implements EntityAdapter.OnEntityClickListener {
     ...
     * @return A new instance of fragment UG.
     */
    // TODO: Rename and change types and number of parameters
    public static UG newInstance(String param1, String param2) {
        UG fragment = new UG();
    ...
    private FragmentUGBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getActivity().setTitle("UG Courses");
        binding = FragmentUGBinding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        binding.recyclerViewUG.setLayoutManager(new LinearLayoutManager(getContext()));
        ...
        try {
            ...
            JSONArray jsonArray = masterObject.getJSONArray("ug");
            ...
            adapter.setUgArrayList(dataArrayList);
            adapter.setListener(this);
            binding.recyclerViewUG.setAdapter(adapter);
        } catch (Exception e) {
