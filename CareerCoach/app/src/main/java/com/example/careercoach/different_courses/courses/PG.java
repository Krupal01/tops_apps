 ...
 * Use the {@link PG#newInstance} factory method to
 * create an instance of this fragment.
 */
public class PG extends Fragment implements EntityAdapter.OnEntityClickListener {
     ...
     * @return A new instance of fragment PG.
     */
    // TODO: Rename and change types and number of parameters
    public static PG newInstance(String param1, String param2) {
        PG fragment = new PG();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getActivity().setTitle("PG Courses");
    ...
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        binding.recyclerViewPG.setLayoutManager(new LinearLayoutManager(getContext()));
        ...
        try{
            ...
            JSONArray jsonArray=masterObject.getJSONArray("pg");
            ...
            adapter.setPgArrayList(dataArrayList);
            adapter.setListener(this);
            binding.recyclerViewPG.setAdapter(adapter);
        }catch (Exception e){
