...
import com.example.careercoach.databinding.FragmentNgoBinding;
 ...
 * Use the {@link Ngo#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Ngo extends Fragment implements MyDataAdapter.onMyDataClickListener {
     ...
     * @return A new instance of fragment Ngo.
     */
    // TODO: Rename and change types and number of parameters
    public static Ngo newInstance(String param1, String param2) {
        Ngo fragment = new Ngo();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getActivity().setTitle("NGO Careers");
    ...
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        binding.recyclerViewNgo.setLayoutManager(new LinearLayoutManager(getContext()));
        ...
        try{
            ...
            JSONArray jsonArray=masterObject.getJSONArray("ngo");
            ...
            adapter.setNgoData(dataArrayList);
            adapter.setListener(this);
            binding.recyclerViewNgo.setAdapter(adapter);
        }catch (Exception e){
