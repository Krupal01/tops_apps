...
import com.example.careercoach.databinding.FragmentManagementBinding;
 ...
 */
public class Management extends Fragment implements EntityAdapter.OnEntityClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getActivity().setTitle("Management Courses");
    ...
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        binding.recyclerViewManagementCourse.setLayoutManager(new LinearLayoutManager(getContext()));
        ...
        try{
            ...
            JSONArray jsonArray=masterObject.getJSONArray("management");
            ...
            adapter.setManagementArrayList(dataArrayList);
            adapter.setListener(this);
            binding.recyclerViewManagementCourse.setAdapter(adapter);
        }catch (Exception e){
