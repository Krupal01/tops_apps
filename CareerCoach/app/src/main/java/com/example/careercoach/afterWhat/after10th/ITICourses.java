...
import com.example.careercoach.databinding.FragmentITICoursesBinding;
 ...
 * Use the {@link ITICourses#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ITICourses extends Fragment implements AfterDataAdapter.onAfterDataClickListener {
     ...
     * @return A new instance of fragment ITICourses.
     */
    // TODO: Rename and change types and number of parameters
    public static ITICourses newInstance(String param1, String param2) {
        ITICourses fragment = new ITICourses();
    ...
    private FragmentITICoursesBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getActivity().setTitle("ITI Courses");
        binding=FragmentITICoursesBinding.inflate(inflater,container,false);
    ...
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        binding.recyclerViewiti.setLayoutManager(new LinearLayoutManager(getContext()));
        ...
        try{
            ...
            JSONArray jsonArray=masterObject.getJSONArray("iti");
            ...
            adapter.setItiData(dataArrayList);
            adapter.setListener(this);
            binding.recyclerViewiti.setAdapter(adapter);
        }catch (Exception e){
