...
import com.example.careercoach.databinding.FragmentMovieCollegesBinding;
 ...
 * Use the {@link MovieColleges#newInstance} factory method to
 * create an instance of this fragment.
 */
public class MovieColleges extends Fragment implements DataAdapter.onDataClickListener {
     ...
     * @return A new instance of fragment MovieColleges.
     */
    // TODO: Rename and change types and number of parameters
    public static MovieColleges newInstance(String param1, String param2) {
        MovieColleges fragment = new MovieColleges();
    ...
    private FragmentMovieCollegesBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getActivity().setTitle("Movie Colleges");
        binding=FragmentMovieCollegesBinding.inflate(inflater,container,false);
    ...
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        try{
            ...
            JSONArray jsonArray=masterObject.getJSONArray("movieColleges");
            ...
            adapter.setDataMovie(dataArrayList);
