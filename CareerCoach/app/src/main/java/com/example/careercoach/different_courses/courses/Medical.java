...
import com.example.careercoach.databinding.FragmentMedicalBinding;
 ...
 */
public class Medical extends Fragment implements EntityAdapter.OnEntityClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getActivity().setTitle("Medical Courses");
    ...
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        binding.recyclerViewMedicalCourse.setLayoutManager(new LinearLayoutManager(getContext()));
        ...
        try{
            ...
            JSONArray jsonArray=masterObject.getJSONArray("medical");
            ...
            adapter.setMedicalArrayList(dataArrayList);
            adapter.setListener(this);
            binding.recyclerViewMedicalCourse.setAdapter(adapter);
        }catch (Exception e){
