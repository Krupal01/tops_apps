...
import com.example.careercoach.databinding.FragmentFinanceBinding;
 ...
 */
public class Finance extends Fragment implements MyDataAdapter.onMyDataClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getActivity().setTitle("Finance Careers");
    ...
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        binding.recyclerViewFinance.setLayoutManager(new LinearLayoutManager(getContext()));
        ...
        try{
            ...
            JSONArray jsonArray=masterObject.getJSONArray("finance");
            ...
            adapter.setFinanceData(dataArrayList);
            adapter.setListener(this);
            binding.recyclerViewFinance.setAdapter(adapter);
        }catch (Exception e){
