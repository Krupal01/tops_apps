...
import com.example.careercoach.databinding.FragmentMarketingBinding;
 ...
 * Use the {@link Marketing#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Marketing extends Fragment implements MyDataAdapter.onMyDataClickListener {
     ...
     * @return A new instance of fragment Marketing.
     */
    // TODO: Rename and change types and number of parameters
    public static Marketing newInstance(String param1, String param2) {
        Marketing fragment = new Marketing();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getActivity().setTitle("Marketing Careers");
    ...
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        binding.recyclerViewMarketing.setLayoutManager(new LinearLayoutManager(getContext()));
        ...
        try{
            ...
            JSONArray jsonArray=masterObject.getJSONArray("marketing");
            ...
            adapter.setMarketingData(dataArrayList);
            adapter.setListener(this);
            binding.recyclerViewMarketing.setAdapter(adapter);
        }catch (Exception e){
