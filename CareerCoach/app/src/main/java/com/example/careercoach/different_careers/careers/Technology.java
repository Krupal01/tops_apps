...
import com.example.careercoach.databinding.FragmentTechnologyBinding;
 ...
 */
public class Technology extends Fragment implements MyDataAdapter.onMyDataClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getActivity().setTitle("Technology Careers");
    ...
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        binding.recyclerViewTechnology.setLayoutManager(new LinearLayoutManager(getContext()));
        ...
        try{
            ...
            JSONArray jsonArray=masterObject.getJSONArray("technology");
            ...
            adapter.setTechnologyData(dataArrayList);
