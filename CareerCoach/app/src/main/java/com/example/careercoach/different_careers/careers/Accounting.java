...
import com.example.careercoach.databinding.FragmentAccountingBinding;
 ...
 */
public class Accounting extends Fragment implements MyDataAdapter.onMyDataClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getActivity().setTitle("Accounting Careers");
    ...
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        binding.recyclerViewAccounting.setLayoutManager(new LinearLayoutManager(getContext()));
        ...
        try{
            ...
            JSONArray jsonArray=masterObject.getJSONArray("accounting");
            ...
            adapter.setAccountingData(dataArrayList);
            adapter.setListener(this);
            binding.recyclerViewAccounting.setAdapter(adapter);
