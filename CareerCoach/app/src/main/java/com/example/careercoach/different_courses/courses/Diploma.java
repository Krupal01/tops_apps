...
import com.example.careercoach.databinding.FragmentDiplomaBinding;
 ...
 */
public class Diploma extends Fragment implements EntityAdapter.OnEntityClickListener {
    ...
    private FragmentDiplomaBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getActivity().setTitle("Diploma Courses");
        binding=FragmentDiplomaBinding.inflate(inflater,container,false);
    ...
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        binding.recyclerViewDiploma.setLayoutManager(new LinearLayoutManager(getContext()));
        ...
        try{
            ...
            JSONArray jsonArray=masterObject.getJSONArray("diploma");
            ...
            adapter.setDiplomaArrayList(dataArrayList);
            adapter.setListener(this);
            binding.recyclerViewDiploma.setAdapter(adapter);
        }catch (Exception e){
