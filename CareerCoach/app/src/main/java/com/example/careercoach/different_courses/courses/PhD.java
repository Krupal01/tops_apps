...
import com.example.careercoach.databinding.FragmentPhDBinding;
 ...
 * Use the {@link PhD#newInstance} factory method to
 * create an instance of this fragment.
 */
public class PhD extends Fragment implements EntityAdapter.OnEntityClickListener {
     ...
     * @return A new instance of fragment PhD.
     */
    // TODO: Rename and change types and number of parameters
    public static PhD newInstance(String param1, String param2) {
        PhD fragment = new PhD();
    ...
    private FragmentPhDBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getActivity().setTitle("PhD Courses");
        binding=FragmentPhDBinding.inflate(inflater,container,false);
    ...
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        binding.recyclerViewPhD.setLayoutManager(new LinearLayoutManager(getContext()));
        ...
        try{
            ...
            JSONArray jsonArray=masterObject.getJSONArray("phd");
            ...
            adapter.setPhdArrayList(dataArrayList);
            adapter.setListener(this);
            binding.recyclerViewPhD.setAdapter(adapter);
        }catch (Exception e){
