...
import com.example.careercoach.databinding.FragmentHealthcareBinding;
 ...
 */
public class Healthcare extends Fragment implements MyDataAdapter.onMyDataClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getActivity().setTitle("Healthcare Careers");
    ...
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        binding.recyclerViewHealthcare.setLayoutManager(new LinearLayoutManager(getContext()));
        ...
        try{
            ...
            JSONArray jsonArray=masterObject.getJSONArray("healthcare");
            ...
            adapter.setHealthcareData(dataArrayList);
            adapter.setListener(this);
            binding.recyclerViewHealthcare.setAdapter(adapter);
        }catch (Exception e){
