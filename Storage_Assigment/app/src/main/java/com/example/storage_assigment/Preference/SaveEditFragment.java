...
import com.example.storage_assigment.databinding.FragmentSaveEditBinding;
...
public class SaveEditFragment extends Fragment {
     ...
     * @return A new instance of fragment SaveEditFragment.
     */
    ...
    private FragmentSaveEditBinding binding;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        binding = FragmentSaveEditBinding.inflate(inflater,container,false);
    ...
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        binding.save.setOnClickListener(v -> {
            ...
            editor.putString("Preference",binding.preference.getText().toString());
            editor.commit();
        ...
        binding.Edit.setOnClickListener(v -> {
            SharedPreferences sharedPreferences = getContext().getSharedPreferences("preference",Context.MODE_PRIVATE);
            binding.preference.setText(sharedPreferences.getString("Preference",""));
