...
import com.example.storage_assigment.databinding.FragmentInternalStorageBinding;
...
public class InternalStorageFragment extends Fragment {
    ...
    private FragmentInternalStorageBinding binding;
    @Override
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.WriteInternal.setOnClickListener(v -> {
        ...
        binding.readInternal.setOnClickListener(v -> {
            try{
                ...
                binding.readText.setText(msg);

            }catch (Exception e){
                binding.readText.setText(e.toString());
            }
        });
