...
import com.example.storageassignment.databinding.FragmentLoginSchoolBinding;
 ...
 * Use the {@link LoginSchoolFragment#newInstance} factory method to
...
public class LoginSchoolFragment extends Fragment {
     ...
     * @return A new instance of fragment LoginSchoolFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static LoginSchoolFragment newInstance(String param1, String param2) {
        LoginSchoolFragment fragment = new LoginSchoolFragment();
    ...
    private FragmentLoginSchoolBinding binding;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        binding = FragmentLoginSchoolBinding.inflate(inflater,container,false);
    ...
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        binding.login.setOnClickListener(v -> {
            ...
            if (student.equals(studentPreference) && password.equals(passwordPreference)) {
                ...
                editor.commit();
                Navigation.findNavController(getView()).navigate(R.id.action_loginSchoolFragment_to_homeFragment3);
            }
        });
