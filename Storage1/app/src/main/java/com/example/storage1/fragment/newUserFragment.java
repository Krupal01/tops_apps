...
import com.example.storage1.databinding.FragmentNewUserBinding;
...
public class newUserFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.btnSubmit.setOnClickListener(v -> {
            ...
            newUser.firstname = binding.firstname.getText().toString();
            newUser.lastname = binding.lastname.getText().toString();
