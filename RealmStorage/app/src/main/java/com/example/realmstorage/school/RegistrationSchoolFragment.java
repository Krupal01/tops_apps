...
import com.example.realmstorage.databinding.FragmentRegistrationSchoolBinding;
    ...
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        binding.submit.setOnClickListener(v -> {
            if (binding.password.getText().toString().equals(binding.confirmPassword.getText().toString())){
                ...
                Navigation.findNavController(getView()).navigate(R.id.action_registrationSchoolFragment_to_loginFragment);
